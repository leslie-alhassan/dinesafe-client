        ...
        <article className='about'>
          ...
          <ul className='about__status about__status--conditional'>
            ...
            <li className='about__status__detail'>
              ...
              days), or as soon as possible after the operators advise they are
              ready.
            </li>

            <h3 className='about__status__subheader'>Correction Categories</h3>

            <li className='about__status__detail'>Food Temperature Control</li>
            <li className='about__status__detail'>
          ...
          <ul className='about__status about__status--closed'>
            ...
            <li className='about__status__detail'>
              ...
              public and the food premises was ordered closed by a Public Health
              Inspector.
            </li>
            <li className='about__status__detail'>
              The food premises must stay closed and not serve food to the
              public until it has earned a pass from a Public Health Inspector.
            </li>
            ...
            <li className='about__status__detail'>No hot/cold running water</li>
